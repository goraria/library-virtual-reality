...
public class NoteController : MonoBehaviour {
    ...
    [Header("Image Array")]
    [SerializeField] private Sprite[] images0;  // Mảng chứa các hình ảnh cho displayImage0
    [SerializeField] private Sprite[] images1;  // Mảng chứa các hình ảnh cho displayImage1
    ...
    public void ShowNote() {
        ...
        // Đặt lại chỉ số hình ảnh và hiển thị hình ảnh đầu tiên
        currentImageIndex = 0;
        ShowImage();
    }
    ...
    void DisableNote() {
        ...
        isOpen = false;
        HideImage();  // Đảm bảo ảnh sẽ bị đóng khi đóng canvas
    }

    public void ShowImage() {
        if (images0.Length > 0 && images1.Length > 0 && currentImageIndex < images0.Length && currentImageIndex < images1.Length) {
            // Hiển thị cùng một chỉ mục hình ảnh trên cả hai UI Image
    ...
    private void Update() {
        ...
        if (Input.GetKeyDown(openImageKey) && isOpen) {
...
// public class NoteController0 : MonoBehaviour {
//     [Header("Input")]
//     [SerializeField] private KeyCode closeKey;
//
//     //[Space(10)]
...
// public class NoteController1 : MonoBehaviour {
//     [Header("Input")]
//     [SerializeField] private KeyCode closeKey;
//     [SerializeField] private KeyCode openImageKey = KeyCode.Return;  // Phím mở hình ảnh tiếp theo
//     [SerializeField] private KeyCode previousImageKey = KeyCode.Backspace;  // Phím mở hình ảnh trước đó
